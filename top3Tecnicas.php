<HTML>
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
            ...
            $dattop3 = t3Tecnicas($pLine,$pMonth,$pDiaI,$pDiaF);
            ...
            if (isset($_REQUEST["btnCalcular"])) {                
                ...
                if ($opcion == "1") {
                    ...
                    $dattop3 = t3TecnicasFrec($pLine,$pMonth,$pDiaI,$pDiaF);    
                    $band = 2;
    ...
    <body>
        ...
        <FORM aling = "center" action="top3Tecnicas.php" method="POST" style=" height: 6vh; width: 120vh;  margin: -1% 40%;">            
            <label>Día: </label>
